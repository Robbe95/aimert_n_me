...
export const inputWrapper = cva({
	base: 'relative flex w-full items-center rounded-input border border-solid border-input-border bg-input shadow-input-shadow ring-offset-background duration-100',
	variants: {
		isDisabled: {
